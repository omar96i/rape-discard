...
var _withScopeId = (n) => (pushScopeId("data-v-1fffbe69"), n = n(), popScopeId(), n);
...
var _sfc_main = defineComponent({
  ...
  setup(__props, { expose, emit: emits }) {
    const props = __props;
    useCssVars((_ctx) => ({
      "71f206e4": unref(tableMinHeightPx),
      "795ccf8c": unref(tableHeightPx)
    }));
    const {
      clickEventType,
      bodyTextDirection,
...
var DataTable = _export_sfc(_sfc_main, [["__scopeId", "data-v-1fffbe69"]]);
