        ...
        >
            ...
            <template #item-actions="item">
                <div class="operation-wrapper">
                    <a href="#" class="btn btn-primary btn-sm" @click="action('edit', item.alimento_id, item.departamento_id)" data-bs-toggle="modal" data-bs-target="#modalAbastecimiento"><i class='bx bxs-edit'></i></a>
                    ...
                    res.data.data.forEach(alimento => {
                        alimento.departamentos.forEach(departamento=>{
                            this.items.push({
                                ...
                                cantidad : departamento.pivot.cantidad,
